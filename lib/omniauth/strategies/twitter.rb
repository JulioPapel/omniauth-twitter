  ...
  module Strategies
    class Twitter < OmniAuth::Strategies::OAuth
      ...
      def request_phase
        ...
        options[:client_options][:authorize_path] = if options[:use_authorize] || request.params["use_authorize"] == "true"
          "/oauth/authorize"
        else
          "/oauth/authenticate"
        end
      ...
      alias_method :old_callback_url, :callback_url

      def callback_url
        request.params["callback_url"] || old_callback_url
      end
